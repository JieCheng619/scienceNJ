...
<div align="center">
  <table width="1024" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <font color="red" size="3">${username }</font>hi，<c:if test="${user.userName==null}">游客</c:if><font size="6" color="red">${user.userName } </font>欢迎来我佳炒货网上商城！<a href="index.do">首页</a>请<a href="javascript:" onClick="bgDiv.style.display='';login.style.display='';">登录</a> <a href="register.jsp">免费注册</a> <c:if test="${user.userName!=null}"><a href="searchOrderByUsername.do?username=${user.userName }">我的订单</a></c:if> <a href="#" class="btn">
