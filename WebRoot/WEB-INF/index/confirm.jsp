  ...
  <table  width="1024" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="824" height="26" valign="top"><div align="right">
       ...
       hi，<c:if test="${user.userName==null}">游客</c:if><font size="6" color="red">${user.userName } </font>欢迎来我佳炒货网上商城！<a href="index.do">首页</a>请<a href="#">登录</a> <a href="index.do">首页</a><a href="register.jsp">免费注册</a> <a href="#">我的订单</a> <a href="#" class="btn">
...
<!-- 定单 start -->
	...
	<center><h2>您好 <font color="red">${user.userName }</font>!请核对您的定单内容,核对好请点击<font color="blue">"确定定单"</font>按钮</h2></center>
	<center>
	<form action="confirm_order.do" method="post">
		<table width="60%">
			<tr>
				<td>客户名称：<input size="8" type=text name="user" value="${user.userName }" readonly></td>
